...
//var myGlyphs = "ABCDEFGHIJKLMNOPQRSTUVWXYZ"; 
var myGlyphs = "abcdefghijklmnopqrstuvwxyz0123456789"; 
...
// ----------------------------------------------------------------------------------------------------
// source: https://graphicdesign.stackexchange.com/questions/737/how-do-i-break-apart-text-in-photoshop
// add a layer for each glyph
...
function splitText() {
    ...
    //var theOriginalTextLayer = thisDocument.artLayers.getByName("split-layer");
	...
	textColor.rgb.red = hexToRgb(myColor).r;
    textColor.rgb.green = hexToRgb(myColor).g;
    textColor.rgb.blue = hexToRgb(myColor).b;

    var fontSize = mySize;         // font size in points
    //var textBaseline = 50;     // the vertical distance in pixels between the top-left corner of the document and the bottom-left corner of the text-box
	var textBaseline = mySize * 2;
    ...
    // this loop will go through each character
        ...
        var theTextBox = newTextLayer.textItem;             // edit the text
            theTextBox.font = myFont;      // set font
...
// -----------------------------------------------------------------------------------------------------------
// source https://gist.github.com/davestewart/4529727 who sourced it from Adobe
